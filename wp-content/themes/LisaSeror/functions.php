...
add_action('init', 'create_post_type_events'); // Add our HTML5 Blank Custom Post Type
...
function create_post_type_galerie() {
    register_taxonomy_for_object_type('category', 'galerie'); // Register Taxonomies for Category
    register_taxonomy_for_object_type('post_tag', 'galerie');
    register_post_type('oeuvres',
        array(
            'labels' => array(
                ...
                'edit' => __('Modifier'),
                'edit_item' => __('Modifier une oeuvre'),
                'new_item' => __('Nouvelle oeuvre'),
                'view' => __('Voir une oeuvre'),
                'view_item' => __('Voir une oeuvre'),
    ...
    register_post_type('videos',
        array(
            'labels' => array(
                ...
                'view' => __('Voir une vidéo'),
                'view_item' => __('Voir une vidéo'),
...
function create_post_type_events() {
    register_taxonomy_for_object_type('category', 'evenements'); // Register Taxonomies for Category
    register_taxonomy_for_object_type('post_tag', 'evenements');
    register_post_type('evenements',
        array(
            'labels' => array(
                ...
                'view' => __('Voir un évènement'),
                'view_item' => __('Voir un évènement'),
